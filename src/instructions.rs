...
pub fn disassemble_next_byte(cursor: &mut Cursor<Vec<u8>>) -> Result<(usize, Instruction), Error> {
    ...
    let instruction = match opcode {
        ...
        0x90 => Instruction::Swap(0),
        0x91 => Instruction::Swap(1),
        0x92 => Instruction::Swap(2),
        0x93 => Instruction::Swap(3),
        0x94 => Instruction::Swap(4),
        0x95 => Instruction::Swap(5),
        0x96 => Instruction::Swap(6),
        0x97 => Instruction::Swap(7),
        0x98 => Instruction::Swap(8),
        0x99 => Instruction::Swap(9),
        0x9a => Instruction::Swap(10),
        0x9b => Instruction::Swap(11),
        0x9c => Instruction::Swap(12),
        0x9d => Instruction::Swap(13),
        0x9e => Instruction::Swap(14),
        0x9f => Instruction::Swap(15),
